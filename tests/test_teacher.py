...
from agent.teacher import _classify_task, create_teacher_plan, main
...
class TeacherTests(unittest.TestCase):
    ...
    def test_plan_node_repo(self):
        ...
        plan = create_teacher_plan(repo, "add a feature")
    ...
    def test_plan_python_repo(self):
        ...
        self.assertIn("pytest", plan.project_profile["commands"])

    def test_task_classification_uses_words(self):
        self.assertEqual(_classify_task("make this repo easy for agents to build features"), "feature implementation")
    ...
    def test_existing_files_skipped_unless_force(self):
        ...
        self.assertIn("Claude Harness", claude.read_text(encoding="utf-8"))
